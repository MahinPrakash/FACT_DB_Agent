...
# from DB_Agent_System_Prompt import FR_SYSTEM_PROMPT,SYSTEM_PROMPT,MULTIPLE_DATASETS_SYSTEM_PROMPT,db_metadata
...
# laad_df=pd.read_excel("./datasets/dummy_datasets_v2/LAAD_Data.xlsx")
# xponent_df=pd.read_excel("./datasets/dummy_datasets_v2/Xponent_Data.xlsx")
# weekly_sales_crediting_df=pd.read_excel("./datasets/dummy_datasets_v2/weekly_sales_crediting_file_v2.xlsx")
# territory_mapping_df=pd.read_excel("./datasets/dummy_datasets_v2/Territory_Mapping.xlsx")
# zip_to_territory_mapping_df=pd.read_excel("./datasets/dummy_datasets_v2/Zip_To_Terr.xlsx")
# roster_df=pd.read_excel("./datasets/dummy_datasets_v2/Roster_Data.xlsx")
# ic_goals_df=pd.read_excel("./datasets/dummy_datasets_v2/IC_goals_data.xlsx")
# segmentation_df=pd.read_excel("./datasets/dummy_datasets_v2/Segmentation Data.xlsx")
# rdtr_df=pd.read_excel("./datasets/dummy_datasets_v2/RDTR.xlsx")
# plan_df=pd.read_excel("./datasets/dummy_datasets_v2/Plan_Data.xlsx")
# hcp_master_df=pd.read_excel("./datasets/dummy_datasets_v2/HCP_Master.xlsx")
# ic_national_summary_df=pd.read_excel("./datasets/dummy_datasets_v2/IC National Summary.xlsx")
# ic_summary_df=pd.read_excel("./datasets/dummy_datasets_v2/IC Summary.xlsx")
# national_summary_performance_df=pd.read_excel("./datasets/dummy_datasets_v2/National Summary (YTD Performance).xlsx")
# zip_level_sales_df=pd.read_excel("./datasets/dummy_datasets_v2/ZIP LEVEL SALES DATA.xlsx")
